...
?><link rel="stylesheet" href="../../assets/css/admin.css">
     ...
     <?php include '../../app/include/sidebar-admin.php'; ?>
        ...
        <div class="button row">
          ...
          <input name="login"  value="<?php if(empty($login)) echo $username; else echo $login; ?>" type="text" class="form-control" id="formGroupExampleInput">
        </div>
        <div class="col">
          <label for="InputEmail" class="form-label">Email</label>
          <input name="email"  value="<?php if(empty($mail)) echo $email; else echo $mail;?>" readonly type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
         </div>
        <div class="col">
          <label for="InputPassword" class="form-label">Скинути пароль</label>
        ...
        <input name="admin" value="1" type="checkbox" class="form-check-input" id="flexCheckChecked">
          ...
          <div class="col">
            <button name="update-user" class="btn btn-primary" type="submit">Оновити</button>
           </div>
            </form>
          </div>
        </div>
